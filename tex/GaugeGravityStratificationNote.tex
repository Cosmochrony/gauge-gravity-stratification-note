  ...
  \section{Outputs to Downstream Branches}
    ...
    \begin{table}[ht]
      ...
      \begin{tabular}{@{}p{5.5cm}p{4.5cm}l@{}}
        ...
        $[\mathrm{H\text{-}color}]$ conditionality of $\SU(3)$ sector & See Note~3 & S \\
        \bottomrule
      \end{tabular}
    \end{table}
  ...
  \section{Status of Results}
    ...
    \subsection{Open hypotheses}
      ...
      \begin{enumerate}
        ...
        \item \textit{[H-color] for the $\SU(3)$ sector.}
        Inherited from Notes~1 and~3: the $\SU(3)$ identification is established unconditionally
        on the colour-adapted graph and at three analytical levels on the standard graph.
        The $[\mathrm{H\text{-}color}]_{\mathrm{pointwise}}$ component remains open.
      \end{enumerate}
